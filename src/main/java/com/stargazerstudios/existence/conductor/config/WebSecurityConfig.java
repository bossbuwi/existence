...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers(WebSecurityURI.Unguarded.URI_USER_COUNT).permitAll()
                .antMatchers(WebSecurityURI.Unguarded.URI_SYSTEM_COUNT).permitAll()
                .antMatchers(WebSecurityURI.Unguarded.URI_EVENT_COUNT).permitAll()
                .antMatchers(WebSecurityURI.Unguarded.URI_EVENT_LATEST).permitAll()
